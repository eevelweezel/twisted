...
class SynchronousTestCase(_Assertions):
    ...
    def getSkip(self) -> Tuple[bool, Optional[str]]:
        ...
        instance first, then the class. As soon as it finds something with a
        C{skip} attribute, returns that in a tuple (L{True}, L{str}).
        ...
        """
        skipReason = util.acquireAttribute(self._parents[:-1], "skip", None)
